...
const Aboutdata: datatype[] = [
    {
        ...
        paragraph: 'We provide a conducive learning environment to cater to all of our pupils.'
        
    },
    {
        heading: "Excellent Academics.",
        imgSrc: "/images/aboutus/imgTwo.svg",
        paragraph: 'We provide measures to ensure we maintain high teaching and learning standards.'
        
    },
    {
        heading: "Interactive Activities.",
        imgSrc: "/images/aboutus/imgThree.svg",
        paragraph: 'We provide a variety of in door and out door activities for our puplis.'
    ...
    return (
        ...
        <div id="aboutus-section">
            <div className='mx-auto max-w-7xl px-4 py-24 my-32 lg:px-10 bg-lightgrey rounded-3xl relative'>
                ...
                <h4 className='text-center text-4xl lg:text-65xl font-bold'>Know more about MCL.</h4>
