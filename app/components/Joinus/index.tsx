        ...
        <div className="bg-joinus my-32" id="enroll">
            <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8'>
                ...
                <div className="text-center">
                    ...
                    <p className="text-lightblack text-base font-normal">We accept kids in all classes from toddlers, preschool, elementary and secondary. Leave your details with us and we will be in touch</p>
                </div>
